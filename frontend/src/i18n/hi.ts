...
export const HI: Partial<Record<keyof typeof EN, string>> = {
  ...
  /* ------------------------------------------------------------- report */
  "report.masthead": "पैकेज्ड वस्तुओं का स्वचालित अनुपालन मूल्यांकन",
  ...
  "report.score": "स्कोर",
  "report.productImage": "उत्पाद की छवि",
  "report.imageUnavailable": "उत्पाद की छवि उपलब्ध नहीं — इसे जोड़ा नहीं जा सका।",
  "report.declarations": "लेबल से पढ़ी गई घोषणाएँ",
  "report.requirements": "जाँची गई आवश्यकताएँ",
  "report.lettering": "अक्षरों के आकार का अनुपालन",
  "report.scope": "इस मूल्यांकन का दायरा",
  "report.selectedChecks": "चुनी गई जाँचें",
  "report.selectedNote": "यह मूल्यांकन ऊपर सूचीबद्ध घोषणाओं तक सीमित है। इनके बाहर की आवश्यकताओं की यहाँ जाँच नहीं की गई, और इस दस्तावेज़ से उनके बारे में कोई निष्कर्ष नहीं निकाला जाना चाहिए।",
  "report.outsideSelection": "चुनी गई जाँचों के बाहर, पढ़ने में {n} अन्य समस्या(एँ) भी मिलीं। वे इस स्कैन के पूर्ण मूल्यांकन में दर्ज हैं।",
  "report.requirement": "आवश्यकता",
  "report.finding": "निष्कर्ष",
  "report.detected": "पाया गया",
  "report.readAt": "{n}% विश्वसनीयता से पढ़ा गया",
  "report.notDetected": "नहीं मिला",
  "report.language": "रिपोर्ट की भाषा",
  "report.compliant": "अनुपालन में",
  "report.nonCompliant": "अनुपालन में नहीं",
  ...
  "field.unit_sale_price": "इकाई विक्रय मूल्य",
  "field.manufacturer": "निर्माता",
  "field.packer": "पैकर",
  "field.address": "पता",
  "field.consumer_care_phone": "उपभोक्ता सेवा — फ़ोन",
  "field.consumer_care_email": "उपभोक्ता सेवा — ईमेल",
  "field.manufacturing_date": "निर्माण तिथि",
  "field.packing_date": "पैकिंग तिथि",
  "field.expiry_date": "समाप्ति / उपयोग की अंतिम तिथि",
  "field.best_before": "बेस्ट बिफ़ोर",
  "field.shelf_life": "शेल्फ़ लाइफ़",
  ...
  "check.manufacturer_or_packer": "निर्माता, पैकर या आयातक घोषित",
  "check.generic_product_name": "सामान्य या जेनेरिक नाम घोषित",
  "check.net_quantity": "शुद्ध मात्रा घोषित",
  "check.mrp": "खुदरा विक्रय मूल्य घोषित",
  "check.consumer_care_details": "उपभोक्ता सेवा संपर्क घोषित",
  "check.manufacturing_date": "निर्माण या पैकिंग का माह और वर्ष",
  "check.best_before_or_use_by": "बेस्ट बिफ़ोर या उपयोग की अंतिम तिथि",
  "check.batch_number": "बैच या लॉट संख्या",
  "check.country_of_origin": "मूल देश",
  "check.unit_sale_price": "इकाई विक्रय मूल्य घोषित",
  "check.unit_price_consistency": "इकाई विक्रय मूल्य MRP और मात्रा के अनुरूप",
  "check.font_size_readability": "घोषणाएँ अपेक्षित आकार में पठनीय",
  "check.misleading_declarations": "कोई भ्रामक घोषणा नहीं मिली",
  "check.non_standard_declarations": "कोई गैर-मानक घोषणा प्रारूप नहीं मिला",
  "check.dimensions": "वस्तु के आयाम",
